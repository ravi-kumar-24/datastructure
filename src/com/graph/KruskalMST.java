...
public class KruskalMST {
    ...
    public List<Edge<Integer>> getMST(Graph<Integer> graph) {
        ...
        List<Edge<Integer>> allEdges1 = allEdges;
        Comparator<Edge<Integer>> edgeComparator =new EdgeComparator(); //(e1, e2 ) -> e1.getWeight() <= e2.getWeight() ?1:-1;
        Comparator<Edge<Integer>> edgeComparator1 =(e1, e2 ) -> e1.getWeight() <= e2.getWeight() ? 1:-1;

        //sort all edges in non decreasing order
        Collections.sort(allEdges, edgeComparator1);
